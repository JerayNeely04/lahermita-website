  ...
  return (
    ...
    >
      ...
      <div className="container-x text-center">
        ...
        <h2 id="our-blends-heading" className="font-display text-4xl md:text-5xl text-gold mb-4">
          Our Blends
        </h2>
